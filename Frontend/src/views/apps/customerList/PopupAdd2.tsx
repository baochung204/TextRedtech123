      ...
      >
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            ...
            />
            <CustomFormLabel htmlFor="phone-text" sx={{ mt: 2 }}>
              SĐT
            </CustomFormLabel>
            <CustomTextField
              id="phone-text"
            ...
            />
            <CustomFormLabel htmlFor="address-text" sx={{ mt: 2 }}>
              Địa chỉ
            </CustomFormLabel>
            <CustomTextField
              id="address-text"
            ...
            />
            <CustomFormLabel htmlFor="email-text" sx={{ mt: 2 }}>
              Email
            </CustomFormLabel>
            <CustomTextField
              id="email-text"
          ...
          <Grid item xs={12} md={6}>
            ...
            />
            <CustomFormLabel htmlFor="channel-select" sx={{ mt: 2 }}>
              Kênh
            </CustomFormLabel>
            <CustomSelect
              id="channel-select"
              ...
              renderValue={(selected: any) => (
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                  {selected.map((value: any) => (
                    ...
                    >
                      <ListItemText
                        primary={channels.find((channel) => channel.value === value)?.label}
                      />
                    </Box>
                  ))}
                </Box>
