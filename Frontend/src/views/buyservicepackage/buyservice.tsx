...
const BCrumb = [
  ...
  {
    title: 'Buy Point Service Package',
  },
];
...
const BuyPointService = () => {
  ...
  return (
    <PageContainer title="Buy Point Service" description="this is Buy Point Service page">
      {/* breadcrumb */}
      <Breadcrumb title="Buy Point Service Package" items={BCrumb} />
      {/* end breadcrumb */}

      <Grid container spacing={3} justifyContent="center" mt={3}>
        <Grid item xs={12} sm={10} lg={8} textAlign="center">
          <Typography variant="h2" sx={{ color: '#35418E' }}>
...
export default BuyPointService;
