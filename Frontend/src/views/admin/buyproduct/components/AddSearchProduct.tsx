...
import SimpleDialog from 'src/components/apps/assistant/AssistantEditor/dialog/searchDialog'
// import SimpleDialog from 'src/components/apps/assistant/AssistantEditor/layout/addSearch'
