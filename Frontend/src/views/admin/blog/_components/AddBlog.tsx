...
const AddBlog = () => {
  ...
  // Hàm để chèn hình ảnh vào ReactQuill
  ...
  // Tạo tham chiếu tới ReactQuill

  return (
    <Scrollbar_y sx={{ maxHeight: '650px' }}>
      <form onSubmit={formik.handleSubmit} style={{ paddingInline: '10px' }}>
        <Box
          mb={4}
          p={4}
          sx={{
