              ...
              {paginatedData.map((item, index) => {
                return (
                  <TableRow key={index}>
                    ...
                    >
                      <Typography variant="subtitle2">{item.money} VNĐ</Typography>
                    </TableCell>
                    <TableCell
                      sx={{
                        whiteSpace: 'nowrap',
                    ...
                    >
                      <Typography variant="subtitle2">{item.totalBuy}</Typography>
                    </TableCell>
                    <TableCell
                      sx={{
                        whiteSpace: 'nowrap',
                    ...
                    >
                      <Typography variant="subtitle2">{item.function}</Typography>
                    </TableCell>
                    <TableCell
                      sx={{
                        whiteSpace: 'nowrap',
                    ...
                    >
                      <Typography variant="subtitle2">{item.strategy}</Typography>
                    </TableCell>
                    <TableCell
                      sx={{
                        whiteSpace: 'nowrap',
                    ...
                    >
                      <Typography variant="subtitle2">{item.files}</Typography>
                    </TableCell>
                    <TableCell
                      sx={{
                        whiteSpace: 'nowrap',
                    ...
                    >
                      <Typography variant="subtitle2">{item.totalFunction}</Typography>
                    </TableCell>
                    <TableCell
                      sx={{
                        whiteSpace: 'nowrap',
