...
const RPointDialog = ({ open, setOpen, checkValue, selectID }: PropsDialog) => {
  ...
  const validateSchema = Yup.object({
    package: Yup.string().required('Tên gói R-Point là bắt buộc.'),
    points: Yup.string().required('Số Point là bắt buộc.'),
    money: Yup.string().required('Số tiền là bắt buộc.'),
    model: Yup.string().required('Model là bắt buộc.'),
    function: Yup.string().required('Hành động là bắt buộc.'),
    strategy: Yup.string().required('Chiến lược là bắt buộc.'),
    files: Yup.string().required('Files là bắt buộc.'),
    function2: Yup.string().required('Hành động là bắt buộc.'),
    totalFunction: Yup.string().required('totalFunction là bắt buộc.'),
    totalBuy: Yup.string().required('totalBuy là bắt buộc.'),
  });
