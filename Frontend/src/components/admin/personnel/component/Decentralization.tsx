            ...
            {PersonnelTable.map((emp) => (
              <ListItemButton key={emp.id} onClick={() => handleSelectEmployee(emp)}>
                <Stack direction="row" spacing={2}>
                  <Avatar src={emp.avt} />
                  <ListItemText primary={emp.employeeName} secondary={emp.email} />
                </Stack>
              </ListItemButton>
            ))}
          </List>
        ...
        <Box sx={{ mt: 2 }}>
          ...
          >
            ...
            {selectedEmployee.status ? (
              ...
              <Box
                sx={{ backgroundColor: 'error.light', padding: 1, paddingX: 1, borderRadius: 1.5 }}
              >
                ...
                {functions.map((func) => {
                  ...
                  return (
                    <TableRow key={func.name}>
                      <TableCell>
                        <Typography variant="subtitle2">{func.name}</Typography>
                      </TableCell>
