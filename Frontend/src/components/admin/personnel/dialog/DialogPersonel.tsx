...
const DialogPersonel = ({
  ...
  const validationSchema = Yup.object({
    ...
    numberPhone: Yup.string()
      .matches(/^[0-9]+$/, 'Số điện thoại từ 0-9')
  ...
  return (
    ...
    >
      <DialogTitle id="alert-dialog-title" sx={{ textAlign: 'center' }}>
        {isViewMode ? (
          <>{isCheckFix ? 'Xem thông tin nhân viên' : 'Sửa thông tin nhân viên'}</>
        ) : (
          'Thêm nhân viên'
        )}
      </DialogTitle>
                  ...
                  <Grid container>
                    ...
                    <Grid item xs={12}>
                      <Box sx={{ textAlign: 'center' }}>
                        ...
                        <Typography variant="h6">Ngày tạo : 20/08/2024</Typography>
                      </Box>
                    </Grid>
                  </Grid>
                </Grid>
