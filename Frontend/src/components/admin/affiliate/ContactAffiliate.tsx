...
const ContactAffiliate = () => {
  ...
  useEffect(() => {
    dispatch(fetchOverviewContractAffiliateData());
  }, [dispatch]);

  const pendingContract = contractAffiliateOverview.pendingContract;
  const rejectedContract = contractAffiliateOverview.rejectedContract;
  const signedContract = contractAffiliateOverview.signedContract;
  const totalContract = contractAffiliateOverview.totalContract;
  const dataSource = [
    {
