...
var TreeViewContext = React45.createContext({});
if (true) {
...
var DescendantContext = React46.createContext({});
if (true) {
...
function useDescendant(descendant) {
  const [, forceUpdate] = React46.useState();
  const {
    registerDescendant = noop,
    unregisterDescendant = noop,
    descendants = [],
    parentId = null
  } = React46.useContext(DescendantContext);
...
function DescendantProvider(props) {
  ...
  const [items, set] = React46.useState([]);
  const registerDescendant = React46.useCallback((_ref) => {
    let {
      element
  ...
  const unregisterDescendant = React46.useCallback((element) => {
  ...
  return (0, import_jsx_runtime21.jsx)(DescendantContext.Provider, {
    value,
    children
  });
}
...
function useTreeItem(nodeId) {
  const {
    ...
    selectRange,
    toggleExpansion
  } = React47.useContext(TreeViewContext_default);
...
var _excluded9 = ["classes", "className", "displayIcon", "expansionIcon", "icon", "label", "nodeId", "onClick", "onMouseDown"];
var TreeItemContent = React48.forwardRef(function TreeItemContent2(props, ref) {
  const {
    classes,
    className,
    displayIcon,
  ...
  return (
    ...
    (0, import_jsx_runtime23.jsxs)("div", _extends({
...
true ? TreeItemContent.propTypes = {
   ...
   */
  displayIcon: import_prop_types9.default.node,
  /**
   * The icon to display next to the tree node's label. Either an expansion or collapse icon.
   */
  expansionIcon: import_prop_types9.default.node,
  /**
   ...
   * The id of the node.
   */
  nodeId: import_prop_types9.default.string.isRequired,
  /**
   * @ignore
   */
...
var _excluded10 = ["children", "className", "collapseIcon", "ContentComponent", "ContentProps", "endIcon", "expandIcon", "disabled", "icon", "id", "label", "nodeId", "onClick", "onMouseDown", "TransitionComponent", "TransitionProps"];
...
var TreeItem = React49.forwardRef(function TreeItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTreeItem"
  });
  ...
  const {
    ...
    unregisterNode,
    treeId
  } = React49.useContext(TreeViewContext_default);
  let id = null;
  if (idProp != null) {
    id = idProp;
  ...
  const [treeitemElement, setTreeitemElement] = React49.useState(null);
  const contentRef = React49.useRef(null);
  const handleRef = useForkRef_default(setTreeitemElement, ref);
  const descendant = React49.useMemo(() => ({
  ...
  return (0, import_jsx_runtime25.jsxs)(TreeItemRoot, _extends({
    className: clsx_m_default(classes.root, className),
    role: "treeitem",
    ...
    ownerState,
    onFocus: handleFocus,
    children: [(0, import_jsx_runtime24.jsx)(StyledTreeItemContent, _extends({
      as: ContentComponent,
      ref: contentRef,
      classes: {
      ...
      displayIcon,
      ownerState
    }, ContentProps)), children && (0, import_jsx_runtime24.jsx)(DescendantProvider, {
      id: nodeId,
      children: (0, import_jsx_runtime24.jsx)(TreeItemGroup, _extends({
...
true ? TreeItem.propTypes = {
   ...
   */
  collapseIcon: import_prop_types10.default.node,
  /**
   ...
   */
  ContentProps: import_prop_types10.default.object,
  /**
...
var _excluded11 = ["children", "className", "defaultCollapseIcon", "defaultEndIcon", "defaultExpanded", "defaultExpandIcon", "defaultParentIcon", "defaultSelected", "disabledItemsFocusable", "disableSelection", "expanded", "id", "multiSelect", "onBlur", "onFocus", "onKeyDown", "onNodeFocus", "onNodeSelect", "onNodeToggle", "selected"];
...
var TreeView = React50.forwardRef(function TreeView2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTreeView"
  });
  ...
  const treeRef = React50.useRef(null);
  const handleRef = useForkRef_default(treeRef, ref);
  const [focusedNodeId, setFocusedNodeId] = React50.useState(null);
  const nodeMap = React50.useRef({});
  const firstCharMap = React50.useRef({});
  ...
  const isExpanded = React50.useCallback((id) => Array.isArray(expanded) ? expanded.indexOf(id) !== -1 : false, [expanded]);
  const isExpandable = React50.useCallback((id) => nodeMap.current[id] && nodeMap.current[id].expandable, []);
  const isSelected = React50.useCallback((id) => Array.isArray(selected) ? selected.indexOf(id) !== -1 : selected === id, [selected]);
  const isDisabled = React50.useCallback((id) => {
  ...
  const lastSelectedNode = React50.useRef(null);
  const lastSelectionWasRange = React50.useRef(false);
  const currentRangeSelection = React50.useRef([]);
  ...
  const registerNode = React50.useCallback((node) => {
    const {
      id,
      index,
      parentId,
  ...
  const unregisterNode = React50.useCallback((id) => {
  ...
  const mapFirstChar = React50.useCallback((id, firstChar) => {
    firstCharMap.current[id] = firstChar;
  }, []);
  const unMapFirstChar = React50.useCallback((id) => {
  ...
  return (0, import_jsx_runtime26.jsx)(TreeViewContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime26.jsx)(DescendantProvider, {
      children: (0, import_jsx_runtime26.jsx)(TreeViewRoot, _extends({
        role: "tree",
        id: treeId,
...
true ? TreeView.propTypes = {
   ...
   */
  defaultCollapseIcon: import_prop_types11.default.node,
  /**
   * The default icon displayed next to a end node. This is applied to all
   * tree nodes and can be overridden by the TreeItem `icon` prop.
   */
  defaultEndIcon: import_prop_types11.default.node,
  /**
   * Expanded node ids. (Uncontrolled)
   * @default []
   */
  defaultExpanded: import_prop_types11.default.arrayOf(import_prop_types11.default.string),
  /**
   * The default icon used to expand the node.
   */
  defaultExpandIcon: import_prop_types11.default.node,
  /**
   * The default icon displayed next to a parent node. This is applied to all
   * parent nodes and can be overridden by the TreeItem `icon` prop.
   */
  defaultParentIcon: import_prop_types11.default.node,
  /**
   * Selected node ids. (Uncontrolled)
   * When `multiSelect` is true this takes an array of strings; when false (default) a string.
   * @default []
   */
  defaultSelected: import_prop_types11.default.oneOfType([import_prop_types11.default.arrayOf(import_prop_types11.default.string), import_prop_types11.default.string]),
  /**
   ...
   * @default false
   */
  disableSelection: import_prop_types11.default.bool,
  /**
   * Expanded node ids. (Controlled)
   */
  expanded: import_prop_types11.default.arrayOf(import_prop_types11.default.string),
  /**
   ...
   * @default false
   */
  multiSelect: import_prop_types11.default.bool,
  /**
   * @ignore
   */
   ...
   */
  onNodeFocus: import_prop_types11.default.func,
  /**
   ...
   */
  onNodeSelect: import_prop_types11.default.func,
  /**
   ...
   */
  onNodeToggle: import_prop_types11.default.func,
  /**
   * Selected node ids. (Controlled)
   * When `multiSelect` is true this takes an array of strings; when false (default) a string.
   */
  selected: import_prop_types11.default.oneOfType([import_prop_types11.default.arrayOf(import_prop_types11.default.string), import_prop_types11.default.string]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var _excluded12 = ["children", "className", "component", "columns", "spacing", "defaultColumns", "defaultHeight", "defaultSpacing"];
...
var Masonry = React51.forwardRef(function Masonry2(inProps, ref) {
  ...
  const observer = React51.useRef(typeof ResizeObserver === "undefined" ? void 0 : new ResizeObserver(handleResize));
  React51.useEffect(() => {
  ...
  const lineBreaks = new Array(numberOfLineBreaks).fill("").map((_, index) => (0, import_jsx_runtime27.jsx)("span", {
    "data-class": "line-break",
    style: _extends({}, lineBreakStyle, {
      order: index + 1
    })
  }, index));
  return (0, import_jsx_runtime28.jsxs)(MasonryRoot, _extends({
    as: component,
    className: clsx_m_default(classes.root, className),
    ref: handleRef,
    ownerState
