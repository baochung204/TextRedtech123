    ...
    !function(f, e) {
      ...
      return function(f2) {
        ...
        var F = function(f3) {
          ...
          return n2 && n2.current && ((u2 = n2.current.querySelector("[".concat("data-name", '="').concat(o2, '"]'))) ? (s2 = u2 && u2.offsetLeft || n2.current.firstChild.offsetLeft, m2 = "1") : (s2 = n2.current.firstChild.offsetLeft, m2 = "0")), l.a.createElement(l.a.Fragment, null, l.a.createElement("nav", { onClick: function(f4) {
            ...
            if (false === r2[f4])
              return null;
            var n3 = o2 === f4;
            return n3 && (g2 = e3), l.a.createElement("button", { key: f4, type: "button", className: b()("icn-".concat(f4), { active: n3 }), "data-name": f4 });
        ...
        var sf = ["#aeeff0", "#ffe0e0", "#d6f8b8", "#c6cfff", "#f1f0d1"], bf = null, gf = function() {
          ...
          } }, l.a.createElement(cf, { unified: e2, shouldLoad: d2, native: h2 })));
        }, pf = mf;
        ...
        var _f = function(f3, e2) {
          ...
          return l.a.createElement("ul", { className: "emoji-group", "data-name": e2, "data-display-name": a2[e2], key: e2, style: o2 }, r2);
        }), yf = wf;
        function kf(f3, e2) {
          var n2 = Object.keys(f3);
          if (Object.getOwnPropertySymbols) {
        ...
        var xf = function() {
          ...
          return !r2.length || n2 || false === t2.groupVisibility[g.GROUP_NAME_RECENTLY_USED] ? null : l.a.createElement("ul", { className: "emoji-group", "data-display-name": t2.groupNames[g.GROUP_NAME_RECENTLY_USED], "data-name": g.GROUP_NAME_RECENTLY_USED }, r2.map(function(f4, n3) {
        ...
        var Tf = function() {
          ...
          return Object(u.useEffect)(function() {
            ...
            var n3 = f4 === t2;
            return l.a.createElement("button", { key: f4, id: "t".concat(f4), tabIndex: e3 + 1, style: { transform: "translateX(-".concat(a2 ? 20 * e3 : 0, "px) scale(").concat(n3 ? "1.5" : 1, ")"), zIndex: n3 ? 2 : 1 }, onClick: function() {
              a2 ? d2(f4) : o2();
            } });
          }));
        }), Yf = Vf;
        ...
        function Gf(f3) {
          ...
          return t2.disableSearchBar ? null : l.a.createElement("div", { style: { position: "relative" } }, l.a.createElement("input", { placeholder: n2, className: "emoji-search", onChange: r2, autoFocus: !t2.disableAutoFocus, ref: a2 }), t2.disableSkinTonePicker ? null : l.a.createElement(Yf, { skinToneSpreadRef: d2 }));
        }
        var Jf = Gf;
