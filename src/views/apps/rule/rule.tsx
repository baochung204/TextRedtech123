      ...
      <div style={{ marginTop: '50px' }}>
        ...
        >
          ...
          <div>
            ...
            <ul>
              <li>
                ...
                mới, trong điều kiện có kết nối mạng. Đối tác lựa chọn các Offer phù hợp với mình
                theo loại ứng dụng, loại hệ điều hành, lãnh thổ, và giá cho mỗi conversion.
              </li>
              <li>
              ...
              <li>
                ...
                với các Offer, Redtech cung cấp các công cụ/ tool giúp Đối tác chạy chiến dịch dễ
                dàng hơn.
              </li>
            </ul>
          </div>
          ...
          <div>
            <ol>
              ...
              <li>
                ...
                tác hoặc bất kỳ bên thứ ba nào có quyền nhân bản, can thiệp, gây xáo trộn, hoặc gây
                tổn hại một phần hay toàn bộ tính năng, bản chất dịch vụ dưới bất cứ phương thức nào
                mà không có sự chấp thuận bằng văn bản của Redtech.
              </li>
              <li>
          ...
          <div>
            <ol>
              ...
              <li>
                ...
                nào. Redtech được miễn trừ khỏi các trách nhiệm phát sinh do các thông tin không
                chính xác và/hoặc không được cập nhật trên tài khoản của Đối tác.
              </li>
              <li>
          ...
          <div>
            <ol>
              <li>
                ...
                Redtech theo đúng phạm vi hợp tác đã thỏa thuận. Đối tác đảm bảo các quảng cáo Đối
                tác sử dụng không mang tính chất lừa đảo, vi phạm thuần phong mỹ tục hay vi phạm
                pháp luật, và không vi phạm các chính sách của Redtech đã được công bố.
              </li>
              <li>
              ...
              <li>
                ...
                như sự cố mạng trên diện rộng, tin tặc.... Khi đó Đối tác đồng ý không có bất kỳ
                khiếu nại hoặc theo đuổi kiện tụng chống lại Redtech.
              </li>
              <li>
                ...
                thống Redtech và hiển thị nội dung quảng cáo; (iv) không chứa đựng trực tiếp hoặc
                gián tiếp các nguồn gây hại như virus, spam… làm ảnh hưởng tới hệ thống của Redtech
                và người dùng.
              </li>
              <li>
              ...
              <li>
                ...
                Redtech có quyền áp dụng các biện pháp xử lý gian lận theo quy định tại Điều 5 dưới
                đây.
              </li>
            </ol>
          </div>
          ...
          <p>
            ...
            cùng hệ thống với ngân hàng với Redtech là Ngân hàng Ngoại thương Việt Nam –
          ...
          <p>
            ...
            Đối tác sẽ nhận được thanh toán duy nhất một lần vào một ngày Thứ Sáu cố định trong
            tháng.
          </p>
          ...
          <ol>
            <li>
              ...
              Thông tin bảo mật của Redtech, vì vậy Đối tác có nghĩa vụ tôn trọng và sử dụng thông
              tin một cách đúng đắn.
            </li>
            <li>
              Đối tác đồng ý và công nhận rằng Đối tác sẽ không sử dụng Thông tin bảo mật của
              Redtech để vụ lợi và luôn giữ tuyệt mật những thông tin này. Đối tác sẽ không sử dụng,
              tiết lộ, xuất bản, chuyển giao hoặc cung cấp thông tin cho bất kì bên thứ ba dưới bất
              kì hình thức nào ngoài mục đích phục vụ nội dung hợp tác giữa các Bên.
            </li>
            <li>
              Quy định tại điều này cũng áp dụng đối với tất cả cá nhân có quyền và nghĩa vụ liên
              quan đến việc thực hiện phạm vi hợp tác bao gồm người quản lý, người cố vấn, các phòng
              Đối tác liên quan và nhân sự trực tiếp thực hiện công việc.
            </li>
          </ol>
          ...
          <ol>
            ...
            <li>
              Điều khoản chung này vẫn có giá trị trong trường hợp một trong các Bên có sự thay đổi
              về nhân sự hoặc về cơ cấu quản lý (chia, tách, hợp nhất, sáp nhập, chuyển đổi).
            </li>
            <li>
